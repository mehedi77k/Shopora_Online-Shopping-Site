...
<div class="admin-card"><div class="shop-toolbar"><form class="search-form"><?= session_context_field() ?><input class="form-control" type="search" name="q" value="<?= e($q) ?>" placeholder="Search products"><button class="btn btn-ghost">Search</button></form><span class="muted"><?= count($products) ?> products</span></div>
