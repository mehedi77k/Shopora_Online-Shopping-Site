...
--
-- Host: localhost:3306
-- Generation Time: Sep 12, 2026 at 05:59 PM
...
(1, 'USD', 'US Dollar', '$', '1.161800', 1, NULL, 'Frankfurter', 'https://api.frankfurter.dev/v2/rate/eur/usd', '2026-09-13', '2026-09-12 17:59:27', 1, '2026-09-12 17:59:27');
...
--
ALTER TABLE `currency_rates`
  MODIFY `rate_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
